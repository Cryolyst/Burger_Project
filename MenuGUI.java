...
public class MenuGUI {
	...
	MenuGUI(String myFranchise, String promotion, String name1, String price1, String top1, String name2, String price2,
			String top2, String name3, String price3, String top3, double exchangeRate, double temperature) {
		...
		rate = new JLabel("Exchange Rate: 1:" + String.format("%.1f", exchangeRate) + " Degree:"
				+ String.format("%.1f", temperature) + "\u00B0" + "F" + " (As of " + d + ")");
	...
	class PromotionPanel extends JPanel {
		public void paintComponent(Graphics g) {
			...
			try {
				Thread.sleep(5); // if the text is moving too past/slow, modify here. 2 meant 2 millisecond
									// delayed. 1000 = 1 second
			} catch (Exception exc) {
			}
			repaint();
		}
